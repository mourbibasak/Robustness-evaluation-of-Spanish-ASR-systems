...
#trying with removing SpecAugment
...
#preserving the parameters of the pretrained decoder incase weight matching can be done later.
...
with open_dict(cfg):
    ...
    #train dataset
    cfg.train_ds.manifest_filepath = "/home/mourb/nemo/train/train_manifest.json"
    ...
    # validation dataset
    cfg.validation_ds.manifest_filepath = "/home/mourb/nemo/dev/dev_manifest.json"
...
asr_model.save_to("Conformer_es_large_2.nemo")
